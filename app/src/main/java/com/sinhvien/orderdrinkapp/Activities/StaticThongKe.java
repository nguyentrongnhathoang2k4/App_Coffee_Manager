...
public class StaticThongKe extends AppCompatActivity {
    ...
    public void createRandomBarGraph(String Date1, String Date2){
        ...
        // Chỉ truyền barDataSet vào, không truyền dates
        BarData barData = new BarData(barDataSet);
        XAxis xAxis = barChart.getXAxis();
// Thiết lập định dạng giá trị cho trục X bằng danh sách dates của bạn
        xAxis.setValueFormatter(new IndexAxisValueFormatter(dates));
// Đặt vị trí nhãn ở phía dưới biểu đồ
        xAxis.setPosition(XAxis.XAxisPosition.BOTTOM);
// Tránh việc lặp lại nhãn khi zoom
